...
public class ProductJSON implements Serializable {
	...
	public ProductJSON(Integer productId, String productName,
			Integer productPrice, Integer singlePrice, String productTitle,
			String headImage, Integer currentBuyCount, String buyer,
			String userId, Integer productPeriod, String buyDate,
			Integer buyCount, String productStyle) {
		super();
