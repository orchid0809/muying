...
public class ProductCart implements java.io.Serializable{
	...
	public ProductCart(Integer productId, String productName,
			String productTitle, Integer productPrice, Integer singlePrice,
			String headImage, Integer productCount, Integer count,
			Integer moneyCount, Integer currentBuyCount, Integer productPeriod) {
		super();
