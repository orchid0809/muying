...
//    URL = window.UEDITOR_HOME_URL||tmp.substr(0,tmp.lastIndexOf("\/")+1).replace("_examples/","").replace("website/","");//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:"/admin_back/uploadImages.action"             //图片上传提交地址
        ,imagePath:"/productImg/detail"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
...
//        ,scrawlPath:"/productImg"                        //图片修正地址，同imagePath
        ...
        ,imageManagerPath:"/productImg/detail"                                    //图片修正地址，同imagePath
