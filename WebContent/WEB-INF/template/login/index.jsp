...
<html>
  ...
  <body>
    ...
    <div class="login">
        <div class="login_top">
            <h1><a rel="nofollow" href="<%=ApplicationListenerImpl.sysConfigureJson.getWwwUrl()%>" title="<%=ApplicationListenerImpl.sysConfigureJson.getSaitName()%>">
            ...
            <p><a rel="nofollow" href="<%=ApplicationListenerImpl.sysConfigureJson.getWwwUrl()%>" class="back_home">返回首页</a><a href="<%=ApplicationListenerImpl.sysConfigureJson.getWwwUrl()%>/help/index.html" target="_blank" class="help">帮助中心</a></p>
        </div>
        <div class="login_bg">
        	<div id="loadingPicBlock" class="login_banner">
        	<a target="_blank" href="<%=ApplicationListenerImpl.sysConfigureJson.getWwwUrl()%>">
        	<img width="542" height="360" alt="Hold住全场，仅需1元" src="<%=ApplicationListenerImpl.sysConfigureJson.getImgUrl()%>/Images/loginImg2.jpg"/></a>
        	</div>
            <div class="login_box" id="LoginForm">
                <h3>用户登录</h3>
                <ul>
                    <li class="click"><span>账号：</span><input id="username" type="text" name="username" class="text_name" tabindex="1" /></li>
                    <li class="ts"  id="name_ts">请输入正确的手机号/邮箱</li>
                    <li><span>密码：</span><input id="pwd" type="password" class="text_password" tabindex="2" /><span class="fog"><a id="hylinkGetPassPage" tabindex="5" href="<%=ApplicationListenerImpl.sysConfigureJson.getWwwUrl()%>/getbackpwd/index.html">忘记密码？</a></span></li>
                ...
                <br/>
                    ...
                    开心<%=ApplicationListenerImpl.sysConfigureJson.getShortName() %>，惊喜无限，就在<%=ApplicationListenerImpl.sysConfigureJson.getSaitName()%>，马上注册吧！</p>
                <h4>
                    <a id="hylinkRegisterPage" tabindex="4" class="reg" href="<%=ApplicationListenerImpl.sysConfigureJson.getWwwUrl()%>/register/index.html">立即注册</a></h4>
            </div>
        </div>
    </div>
    <!--login 结束-->
