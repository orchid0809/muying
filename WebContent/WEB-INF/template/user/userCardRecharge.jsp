...
<script type="text/javascript">
    ...
    $("div.sidebar-nav").find("h3").each(function(i,v){
		...
		<div class="R-content">
            ...
            <input type="text" value="" id="txtCard" maxlength="64" style="width: 770px;border: 2px solid #f60;color: #333;padding: 0 3px;height: 34px;line-height: 34px;font-size: 24px;"/>
            <input type="submit" title="确定充值" value="确定充值" style="background: none repeat scroll 0 0 #f60;border: 1px solid #f70;color: #fff;margin-top: 10px;padding: 6px 25px;font-size: 14px;" class="bluebut imm" id="cardButton" />
            </div>
    ...
    <script language="javascript" type="text/javascript">
    	...
    	$("#cardButton").click(function(){
    		...
    		if(key==""){
    			...
    			$.PageDialog("<dl class=\"sAltFail\"><dd>输入卡密密码长度不正确!</dd></dl>",{W:250, H:50,autoClose:true});
    			$("#txtCard").focus();
    			return false;
    		}else{
