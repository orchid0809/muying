...
<div class="R-content">
	...
	<div class="over">
        <ul>
            <li><h3>可用福分：</h3><b class="orange r10">${user.commissionPoints }</b>(<%=ApplicationListenerImpl.sysConfigureJson.getShortName() %>时可抵扣现金<fmt:formatNumber type="number" value="${(user.commissionPoints/100 )} " maxFractionDigits="0"/>元)&nbsp;&nbsp;<a title="如何获得福分" target="_blank" href="/help/userExperience.html">如何获得福分？</a></li>
        </ul>
    </div>
