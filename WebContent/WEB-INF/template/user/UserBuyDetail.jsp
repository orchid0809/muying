...
<script type="text/javascript">
	...
	<div class="R-content">
        ...
        <div class="yg_record_goods">
            <a title="${buyHistoryJSON.productName }" class="fl-img" target="_blank" href="<%=ApplicationListenerImpl.sysConfigureJson.getWwwUrl()%>/products/${buyHistoryJSON.productId }.html"><img src="<%=ApplicationListenerImpl.sysConfigureJson.getImgUrl()%>${buyHistoryJSON.productImg }" /></a>
            <div class="yg_record_r">
                <li><span class="orange">(第${buyHistoryJSON.productPeriod }期)</span> <a class="blue" href="<%=ApplicationListenerImpl.sysConfigureJson.getWwwUrl()%>/products/${buyHistoryJSON.productId }.html" target="_blank">${buyHistoryJSON.productName }</a></li>
                <c:choose>
                	<c:when test="${buyHistoryJSON.buyStatus==1}">
	                	...
	                	<li><a class="bluebut" href="<%=ApplicationListenerImpl.sysConfigureJson.getWwwUrl()%>/lotteryDetail/${buyHistoryJSON.productId }.html" target="_blank">查看详情</a></li>
                	</c:when>
                	 <c:otherwise>
	                	<li><a class="bluebut" href="<%=ApplicationListenerImpl.sysConfigureJson.getWwwUrl()%>/products/${buyHistoryJSON.productId }.html" target="_blank">查看详情</a></li>
	                </c:otherwise>
                </c:choose>
                <li></li>
                </div>
