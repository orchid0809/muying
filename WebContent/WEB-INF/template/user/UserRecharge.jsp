    ...
    $("div.sidebar-nav").find("h3").each(function(i,v){
		...
		<div class="R-content">
            ...
            <div class="select">
                ...
                <ul id="ulMoneyList">
            	    <li style="margin-left:0;" class="selected"><input type="radio" checked="checked" value="10" name="money" id="rd10" onfocus="this.blur()" /> <label for="rd10">充值 <strong>￥</strong><b>10</b></label></li>
                    <li class=""><input type="radio" id="rd50" value="50" name="money" onfocus="this.blur()" /> <label for="rd50">充值 <strong>￥</strong><b>50</b></label></li>
                    <li class=""><input type="radio" id="rd100" value="100" name="money" onfocus="this.blur()" /> <label for="rd100">充值 <strong>￥</strong><b>100</b></label></li>
                    <li><input type="radio" id="rd200" value="200" name="money" onfocus="this.blur()" /> <label for="rd200">充值 <strong>￥</strong><b>200</b></label></li>
            ...
            <div class="charge_money_list">
                ...
                <p class="leix">银行支付：</p>
                 <ul style="border-bottom:1px dashed #e6e7e8;" class="payment">
                    <li class="top">
                        <input type="radio" id="bankType1001" name="account" value="1001"><label for="bankType1001"><span class="zh_bank"></span></label>
                        <input type="radio" id="bankType1002" name="account" value="1002"><label for="bankType1002"><span class="gh_bank"></span></label>
                        <input type="radio" id="bankType1003" name="account" value="1003"><label for="bankType1003"><span class="jh_bank"></span></label>
                        <input type="radio" id="bankType1005" name="account" value="1005"><label for="bankType1005"><span class="nh_bank"></span></label>
                    </li>
                    
                    <li class="top">
                        <input type="radio" id="bankType1004" name="account" value="1004"><label for="bankType1004"><span class="pf_bank"></span></label>  
                        <input type="radio" id="bankType1008" name="account" value="1008"><label for="bankType1008"><span class="sf_bank"></span></label>
                        <input type="radio" id="bankType1009" name="account" value="1009"><label for="bankType1009"><span class="xy_bank"></span></label>
                        <input type="radio" id="bankType1032" name="account" value="1032"><label for="bankType1032"><span class="bj_bank"></span></label>
                    </li>
                    
                    <li class="top">
                        <input type="radio" id="bankType1022" name="account" value="1022"><label for="bankType1022"><span class="gd_bank"></span></label>
                        <input type="radio" id="bankType1006" name="account" value="1006"><label for="bankType1006"><span class="ms_bank"></span></label>
                        <input type="radio" id="bankType1021" name="account" value="1021"><label for="bankType1021"><span class="zx_bank"></span></label>
                        <input type="radio" id="bankType1027" name="account" value="1027"><label for="bankType1027"><span class="gf_bank"></span></label>
                    </li>
                    
                    <li class="top">
                        <input type="radio" id="bankType1010" name="account" value="1010"><label for="bankType1010"><span class="pa_bank"></span></label>
                        <input type="radio" id="bankType1052" name="account" value="1052"><label for="bankType1052"><span class="zg_bank"></span></label>
                        <input type="radio" id="bankType1020" name="account" value="1020"><label for="bankType1020"><span class="jt_bank"></span></label>
                    </li>
                </ul>
                ...
                <ul class="payment">
					...
					%>
                        <input type="radio" id="Tenpay"  name="account" value="Tenpay" />
					...
					%>
                        ...
                        <label for="Yeepay"><span style="background: url('/Images/yeepay.gif') repeat scroll rgba(0, 0, 0, 0);height: 36px;width: 120px;border: 1px solid #ddd;text-indent: -9999px;background-color: #fff;">易宝支付</span></label>
					<%
						}
					%>
					<%
					...
					%>
					<input type="radio" id="aliPayUser" checked="checked" name="account" value="aliPayUser" />
                    <label for="aliPayUser"><span style="background: url('/Images/aliPayUser.png') repeat scroll rgba(0, 0, 0, 0);height: 36px;width: 120px;border: 1px solid #ddd;text-indent: -9999px;background-color: #fff;">支付宝免签</span></label>
                     <%
					}
					%>
					 </li>
					...
					%>
					<input type="radio" id="tenPayUser" name="account" value="tenPayUser" />
                    <label for="tenPayUser"><span style="background: url('/Images/tenPayUser.png') repeat scroll rgba(0, 0, 0, 0);height: 36px;width: 120px;border: 1px solid #ddd;text-indent: -9999px;background-color: #fff;">财付通免签</span></label>
                     <%
					}
					%>
					<%
					...
					%>
					<input type="radio" id="weixinPay" name="account" value="weixinPay" />
                    <label for="weixinPay"><span style="background: url('/Images/bank-logo.gif') repeat scroll rgba(0, 0, 0, 0);height: 36px;width: 120px;border: 1px solid #ddd;text-indent: -9999px;background-color: #fff;background-position: 8px -945px;">微信支付</span></label>
                     <%
					}
					%>
                    </li>
                ...
                <h6>
                    <form target="_blank" method="post" action="<%=ApplicationListenerImpl.sysConfigureJson.getWwwUrl()%>/balance/goBalance.html" name="toPayForm" id="toPayForm">
                ...
                <div style="display:none;" id="payAltBox">
                    <div class="prompt_box">
			            ...
			            <ul>
				            ...
				            <li><a title="重选支付方式" name="btnReSelect" class="look" href="javascript:;">重选支付方式</a></li>
			            </ul>
                    </div>
                </div>
            </div>  
