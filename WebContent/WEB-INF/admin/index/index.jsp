...
<div id="cl-wrapper" class="login-container">
	...
	<div class="middle-login">
		...
		<div class="text-center out-links"><a href="<%=ApplicationListenerImpl.sysConfigureJson.getWwwUrl()%>">&copy; 2014 <%=ApplicationListenerImpl.sysConfigureJson.getSaitName()%></a></div>
	</div> 
</div>
