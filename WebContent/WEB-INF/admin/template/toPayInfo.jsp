...
<input type="hidden" name="sysConfigure.buyProduct" value="${sysConfigure.buyProduct }"/>
 <table width="100%" cellspacing="0">	
		...
		<tr>
			...
			<td>
			<div  style="background: url('/Images/bank_logo.png') repeat scroll 8px -500px rgba(0, 0, 0, 0);height: 36px;width: 120px;border: 1px solid #ddd;text-indent: -9999px;background-color: #fff;">财付通</div>
			</td>
		</tr>	
		<tr>
		...
		<tr>
			...
			<td><input name="sysConfigure.tenpayKey" value="${sysConfigure.tenpayKey }" class="input-text wid300" /></td>
		</tr>
        <tr>
...
<input type="hidden" name="sysConfigure.messageSign" value="${sysConfigure.messageSign }"/>
 <table width="100%" cellspacing="0">	
		...
		<tr>
			<td width="220"  align="right">图片：</td>
			<td>
			<div  style="background: url('/Images/bank_logo.png') repeat scroll 8px -613px rgba(0, 0, 0, 0);height: 36px;width: 120px;border: 1px solid #ddd;text-indent: -9999px;background-color: #fff;">支付宝</div>
			</td>
		</tr>	
		<tr>
			<td width="220" align="right">是否开启：</td>
		...
		<tr>
			...
			<td><input name="sysConfigure.alipayKey" value="${sysConfigure.alipayKey }" class="input-text wid300" /></td>
		</tr>
		<tr>
...
<input type="hidden" name="sysConfigure.messageSign" value="${sysConfigure.messageSign }"/>
 <table width="100%" cellspacing="0">	
		...
		<tr>
			<td width="220"  align="right">图片：</td>
			<td>
			<div  style="background: url('/Images/yeepay.gif') repeat scroll rgba(0, 0, 0, 0);height: 36px;width: 120px;border: 1px solid #ddd;text-indent: -9999px;background-color: #fff;">易宝支付</div>
			</td>
		</tr>	
		<tr>
			<td width="220" align="right">是否开启：</td>
		...
		<tr>
			...
			<td><input name="sysConfigure.yeepayKey" value="${sysConfigure.yeepayKey }" class="input-text wid300" /></td>
		</tr>
        <tr>
        	<td width="220" align="right"></td>
            <td>
