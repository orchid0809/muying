...
<html>
  ...
  <div class="header lr10">
	...
	<s:iterator value="productJSONList" var="productJSONs">
		...
		<td align="center"><img width="50px;" height="50px;" src="<%=ApplicationListenerImpl.sysConfigureJson.getImgUrl()%>/${productJSONs.headImage }"/></td>
		<td align="center"><a href="/products/${productJSONs.productId }.html" target="_blank">[查看]</a> <a href="javascript:;" pid="${productJSONs.productId  }" name="indexTop">[首页推荐]</a></td>
	</tr>
	</s:iterator>
	</tbody>
	</table>
