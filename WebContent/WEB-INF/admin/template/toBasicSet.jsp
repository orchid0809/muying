...
<input type="hidden" name="sysConfigure.buyProduct" value="${sysConfigure.buyProduct }"/>
  <table width="100%" cellspacing="0">	
		...
		<tr>
			...
			<td><input type="text" class="input-text" value="${sysConfigure.domain }" name="sysConfigure.domain" />如：.1ypg.com (请注意前面有点)</td>
		</tr>	
		<tr>
			<td width="220" align="right">JS、CSS域名：</td>
			<td><input type="text" class="input-text" value="${sysConfigure.skinUrl }" name="sysConfigure.skinUrl" />如：http://skin.1ypg.com (请先添加解析，如没有解析请填写http://www.你的域名.com 域名)</td>
		</tr>
		<tr>
			<td width="220" align="right">图片域名：</td>
			<td><input type="text" class="input-text" value="${sysConfigure.imgUrl }" name="sysConfigure.imgUrl" />如：http://img.1ypg.com (请先添加解析，如没有解析请填写http://www.你的域名.com 域名)</td>
		</tr>		
		<tr>
