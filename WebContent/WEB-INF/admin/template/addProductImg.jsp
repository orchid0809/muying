  ...
  <table width="100%" cellspacing="0" cellpadding="0" style="">
	...
	<tr>
		...
		<div align="center" style="float: left;text-align: center;">
			<img src="<%=ApplicationListenerImpl.sysConfigureJson.getImgUrl()%>/productImg/imagezoom/${productimages.piProductId }/${productimages.image }_mid${productimages.imageType }"/>
