...
<!--start-->
  <table width="100%" cellspacing="0">
    ...
    <s:iterator value="orderdetailaddressList" var="orderdetailaddresss" status="st">
			...
			<td ><a href="/lotteryDetail/${orderdetailaddresss.orderDetailId }.html" target="_blank">${orderdetailaddresss.orderDetailId }</a></td>
			...
			<td align="center"><a target="_blank" href="/lotteryDetail/${orderdetailaddresss.orderDetailId }.html">订单详情</a></td>
		</tr>
		</s:iterator>
  	</tbody>
