...
<input type="hidden" name="sysConfigure.buyProduct" value="${sysConfigure.buyProduct }"/>
  <table width="100%" cellspacing="0">
  	<tbody><tr>
		...
		<td><input type="text" class="input-text wid200" value="${sysConfigure.wwwUrl }" name="sysConfigure.wwwUrl" /> 如：http://www.1ypg.com</td>
	</tr>
    <tr>
		...
		<td>
           	...
           	<input name="myFile" class="button" value="上传图片" id="myFile" accept="image/*" type="file" /> 图片大小：105*63
        </td>
	</tr>
  	 <tr>
			<td width="220" align="right">网站名称：</td>
			<td><input type="text" class="input-text wid200" name="sysConfigure.saitName" value="${sysConfigure.saitName }" /> 如：1元云购</td>
	</tr>
	<tr>
			<td width="220" align="right">网站简称：</td>
			<td><input type="text" class="input-text wid200" name="sysConfigure.shortName" value="${sysConfigure.shortName }" /> 如：云购</td>
	</tr>
	<tr>
			<td width="220" align="right">网站标题：</td>
			<td><input type="text" class="input-text wid200" name="sysConfigure.saitTitle" value="${sysConfigure.saitTitle }" /> 如：1元云购 - 惊喜无限</td>
	</tr>
     <tr>
			<td width="220" align="right">网站关键字：</td>
			<td>
			<input type="text" class="input-text wid300" name="sysConfigure.keyword" value="${sysConfigure.keyword }" />如：1元云购,一元云购   （多个关键词请用,号分割）</td>
	</tr>
     <tr>
