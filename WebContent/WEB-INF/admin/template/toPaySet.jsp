...
<!--start-->
  <table width="100%" cellspacing="0">
    ...
    <tbody>
			...
			<td align="center">
			<div  style="background: url('/Images/bank_logo.png') repeat scroll 8px -500px rgba(0, 0, 0, 0);height: 36px;width: 120px;border: 1px solid #ddd;text-indent: -9999px;background-color: #fff;">财付通
			</div>
			</td>
			<td align="center">
				<%
			...
			<td align="center">
			<div  style="background: url('/Images/bank_logo.png') repeat scroll 8px -613px rgba(0, 0, 0, 0);height: 36px;width: 120px;border: 1px solid #ddd;text-indent: -9999px;background-color: #fff;">支付宝
			</div>
			</td>
			<td align="center">
						<%
			...
			<td align="center">
			<div  style="background: url('/Images/yeepay.gif') repeat scroll rgba(0, 0, 0, 0);height: 36px;width: 120px;border: 1px solid #ddd;text-indent: -9999px;background-color: #fff;">易宝支付
			</div>
			</td>
			<td align="center">
				<%
