...
public class SysConfigure implements java.io.Serializable {
	...
	public SysConfigure(Integer id, String imgUrl, String skinUrl,
			String wwwUrl, String domain, String saitName, String shortName,
			String saitTitle, String saitLogo, String keyword,
			String description, String mailName, String mailPwd,
			...
			Integer yeepayStatus, String icp, String serviceQq,
			String serviceTel, String qqAppId, String qqAppKey,
			Integer qqAppStatus, String messagePartner, String messageKey,
			String messageChannel, String messageSign, Double regBalance,
			Double recMoney, Double recBalance, Double commission,
			Integer invite, Integer userData, Integer buyProduct,
