...
//																userService.add(user);
														...
														commissionpoints.setPay("+"+((count*ApplicationListenerImpl.sysConfigureJson.getBuyProduct())-(Integer.parseInt(integral)/100)));
														commissionpoints.setToUserId(Integer.parseInt(userId));
														commissionpointsService.add(commissionpoints);
														
														Integer points = user.getCommissionPoints();
														user.setCommissionPoints(points+((count*ApplicationListenerImpl.sysConfigureJson.getBuyProduct())-(Integer.parseInt(integral)/100)));
